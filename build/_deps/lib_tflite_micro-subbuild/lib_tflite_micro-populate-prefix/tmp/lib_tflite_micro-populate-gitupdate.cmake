...
execute_process(
  COMMAND "/usr/bin/git" show-ref "aa28fd964bc30ea363a9f194bc41e1632fc7755b"
  WORKING_DIRECTORY "/home/user/xmos-template/build/dependencies/lib_tflite_micro"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "aa28fd964bc30ea363a9f194bc41e1632fc7755b")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("aa28fd964bc30ea363a9f194bc41e1632fc7755b" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/aa28fd964bc30ea363a9f194bc41e1632fc7755b")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/user/xmos-template/build/dependencies/lib_tflite_micro'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/user/xmos-template/build/dependencies/lib_tflite_micro'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
